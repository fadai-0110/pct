import os
os.system("python ./pct/train.py --data ./pct/data/my_data.yaml --cfg ./pct/models/yolov5s.yaml --weights ./pct/pretrained/yolov5s.pt --epoch 50 --batch-size 32 --device 0,1")
